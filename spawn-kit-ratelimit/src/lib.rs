//! spawn-kit-ratelimit: Sliding window rate limiter.
//!
//! ## Params: `{"max_operations":100,"window_epochs":43200,"current_count":5,"first_epoch_in_window":12345600}`
...
const ERR_RATE_EXCEEDED: u32 = 0x3001;
